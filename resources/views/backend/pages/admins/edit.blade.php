...
<div class="main-content-inner">
    <div class="row">
            ...
            <div class="card-body">
                ...
                @include('backend.layouts.partials.massages')
                   ...
                   @method('PUT')
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input type="email" class="form-control" id="name" name="email" placeholder="Enter Email" value="{{$admin->email}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="password" class="form-control" id="name" name="password_confirmation" placeholder="Enter Confirm Password">
                            </div>
                        </div>
                        <div class="form-row">
